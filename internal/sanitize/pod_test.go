...
func (p *pod) ForLabels(l map[string]string) *pv1.PodDisruptionBudget {
	return &pv1.PodDisruptionBudget{}
}

func (p *pod) ListPodDisruptionBudgets() map[string]*pv1.PodDisruptionBudget {
	return nil
}
